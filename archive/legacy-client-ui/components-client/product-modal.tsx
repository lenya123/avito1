      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="space-y-4">
            ...
            {isInTransit && product.expected_arrival_date && (
              <div
                className={cn(
                  ...
                  "bg-gradient-to-b from-accent-orange/15 to-accent-orange/5",
                  "border border-accent-orange/25",
                  "backdrop-blur-xl shadow-card",
                  "flex items-center gap-3"
                )}
              >
                <div className="w-9 h-9 rounded-xl bg-accent-orange/15 border border-accent-orange/30 flex items-center justify-center shrink-0 text-lg">
                  📦
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-2xs uppercase tracking-wide text-accent-orange/80">
            ...
            {/* Seller */}
            {product.seller && <SellerChip seller={product.seller} />}
          </div>
