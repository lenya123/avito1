-- confirm_pending_order_atomic v11: убрана ссылка на legacy partner_stock_location
-- (колонка дропается следующими миграциями). Сейчас источник полностью описывается
-- snapshot-полями source_kind / source_binding_id / source_partner_id / source_warehouse.
