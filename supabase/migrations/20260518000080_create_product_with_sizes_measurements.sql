-- create_product_with_sizes: пишем замеры пер-размер (§11.6).
-- Замеры приходят внутри элементов p_sizes: { size, quantity, measurements }.
-- Базируется на актуальном определении (20260507000010, без brand).
