-- confirm_pending_order_atomic v16: вернуть колонку orders.size в INSERT.
-- В v14 (skip_debt_for_vibe) и v15 (full_balance_paid) я случайно
-- упустил эту колонку при копировании из v13 — новые заказы стали
-- писаться с size=NULL, и shipper-PWA снова просил выбрать размер.
--
-- Также backfill для всех existing orders где size=NULL — берём из
