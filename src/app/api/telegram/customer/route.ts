/**
 * Webhook endpoint для customer-bot.
 *
...
import { createCustomerBot } from "@/lib/telegram/bots/customer-bot";

// Lazy-инициализация бота и webhookCallback.
let bot: ReturnType<typeof createCustomerBot> | null = null;
