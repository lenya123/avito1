...
// Единый справочник служб (@/lib/constants/order-status) — было
// локально «Авито»/«Почта», расходилось с заказом/экспортом.
const DELIVERY_SERVICES = Object.entries(DELIVERY_SERVICE_LABELS).map(([value, label]) => ({
  value,
  label,
}));
