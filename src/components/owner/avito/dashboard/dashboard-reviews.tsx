...
import { ReviewCard } from "@/components/owner/avito/review-card";
  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          onClick={() => router.push("/owner/avito/reviews")}
        ...
        {reviews.map((review) => (
          <div key={review.id}>
            <ReviewCard
              ...
              onReply={() => router.push("/owner/avito/reviews")}
              onDeleteAnswer={() => router.push("/owner/avito/reviews")}
            />
          </div>
        ))}
      </div>
