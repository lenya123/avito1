...
import { AvitoAccountSwitcher } from "@/components/owner/avito/avito-account-switcher";
    ...
    <>
      <div className="flex items-center justify-between mb-4 gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          {/* Кнопка «+ Создать» убрана — создание объявления идёт через «+ Создать»
              в блоке «Объявления» (модалка с уникализацией), не через старый /autopost. */}
          <Button
            variant="ghost"
            size="sm"
