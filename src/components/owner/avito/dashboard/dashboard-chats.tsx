...
import { AvitoChatListItem } from "@/components/owner/avito/chat-list-item";
    ...
    <section>
      <div className="flex items-center justify-between mb-3">
        ...
        {chatsData && chatsData.chats.length > 0 && (
          <button
            onClick={() => router.push("/owner/avito/chats")}
        ...
        <div className="space-y-2">
          {chatsData.chats.map((chat) => (
            <AvitoChatListItem
              ...
              onClick={(chatId) => router.push(`/owner/avito/chats/${chatId}`)}
            />
          ))}
        </div>
      ) : (
