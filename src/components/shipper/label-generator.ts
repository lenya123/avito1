...
// Единый справочник служб доставки — было локально, расходилось с UI/экспортом.
import { DELIVERY_SERVICE_LABELS as DELIVERY_LABELS } from "@/lib/constants/order-status";
