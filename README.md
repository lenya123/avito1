...
- [x] Фаза 3 — управление объявлениями (стата +сегодня/заказали, вкл-выкл-удаление, привязка)
- [x] Фаза 4 — автопостинг (флоу, метро, пресеты/микс/уникализатор, Nano Banana, GPT, воркер)
- [x] Фаза 5 — заказы с Avito (объява/трек/комиссии/статус/код возврата, тег панели)
- [x] Фаза 6 — AI-реле (текст/фото/голос ↔ GPT)
- [x] Фаза 7 — полировка (STUB-аудит, доки, ревью типов, чеклист сборки)
